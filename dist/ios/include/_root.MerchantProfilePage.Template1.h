...
namespace g{struct MerchantProfilePage__Template1;}
...
struct MerchantProfilePage__Template1 : ::g::Uno::UX::Template
{
    uWeak< ::g::MerchantProfilePage*> __parent1;
    uWeak< ::g::MerchantProfilePage*> __parentInstance1;
    static ::g::Uno::UX::Selector __selector0_;
    static ::g::Uno::UX::Selector& __selector0() { return MerchantProfilePage__Template1_typeof()->Init(), __selector0_; }

    void ctor_1(::g::MerchantProfilePage* parent, ::g::MerchantProfilePage* parentInstance);
    static MerchantProfilePage__Template1* New2(::g::MerchantProfilePage* parent, ::g::MerchantProfilePage* parentInstance);
};
// }
