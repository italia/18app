// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/HomeIcon.g.uno.
...
::g::Fuse::Controls::Control_type* HomeIcon_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("HomeIcon", options);
...
void HomeIcon::InitializeUX1()
{
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::navigationnew2e85c28e()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::navigationnew2xf9a3ac32()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::navigationnew3x29caa617()));
    Source(temp);
}
