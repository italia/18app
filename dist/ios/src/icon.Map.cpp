...
// {
// static Map() :6
static void Map__cctor_4_fn(uType* __type)
{
}

static void Map_build(uType* type)
{
...
::g::Fuse::Controls::TextControl_type* Map_typeof()
{
    ...
    options.ObjectSize = sizeof(Map);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("icon.Map", options);
    type->fp_build_ = Map_build;
    type->fp_ctor_ = (void*)Map__New4_fn;
    type->fp_cctor_ = Map__cctor_4_fn;
...
// public Map New() [static] :10
Map* Map::New4()
{
    Map* obj1 = (Map*)uNew(Map_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
