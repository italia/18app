...
namespace g{struct app18_accessor_ButtonIcon_Value;}
...
struct app18_accessor_ButtonIcon_Value : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static app18_accessor_ButtonIcon_Value* New1();
};
// }
