...
// {
// static NavBarLogo() :4
static void NavBarLogo__cctor_4_fn(uType* __type)
{
}

static void NavBarLogo_build(uType* type)
{
...
::g::Fuse::Controls::Control_type* NavBarLogo_typeof()
{
    ...
    options.ObjectSize = sizeof(NavBarLogo);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("NavBarLogo", options);
    type->fp_build_ = NavBarLogo_build;
    type->fp_ctor_ = (void*)NavBarLogo__New4_fn;
    type->fp_cctor_ = NavBarLogo__cctor_4_fn;
...
// public NavBarLogo New() :8
void NavBarLogo__New4_fn(NavBarLogo** __retval)
{
    *__retval = NavBarLogo::New4();
}

// public NavBarLogo() [instance] :8
void NavBarLogo::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void NavBarLogo::InitializeUX()
{
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::spidicocirclebbf1468edf()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::spidicocirclebb2x14662c15()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::spidicocirclebb3x193b34b0()));
    Source(temp);
}

// public NavBarLogo New() [static] :8
NavBarLogo* NavBarLogo::New4()
{
    NavBarLogo* obj1 = (NavBarLogo*)uNew(NavBarLogo_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
