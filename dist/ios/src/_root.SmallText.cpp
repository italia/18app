// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/SmallText.g.uno.
...
// public partial sealed class SmallText :2
// {
// static SmallText() :4
static void SmallText__cctor_4_fn(uType* __type)
{
}

static void SmallText_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* SmallText_typeof()
{
    ...
    options.ObjectSize = sizeof(SmallText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("SmallText", options);
    type->fp_build_ = SmallText_build;
    type->fp_ctor_ = (void*)SmallText__New4_fn;
    type->fp_cctor_ = SmallText__cctor_4_fn;
...
// public SmallText() :8
void SmallText__ctor_8_fn(SmallText* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void SmallText__InitializeUX1_fn(SmallText* __this)
{
    __this->InitializeUX1();
}

// public SmallText New() :8
void SmallText__New4_fn(SmallText** __retval)
{
    *__retval = SmallText::New4();
}

// public SmallText() [instance] :8
void SmallText::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
// public SmallText New() [static] :8
SmallText* SmallText::New4()
{
    SmallText* obj1 = (SmallText*)uNew(SmallText_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
