// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/LogoutIcon.g.uno.
...
// public partial sealed class LogoutIcon :2
// {
// static LogoutIcon() :4
static void LogoutIcon__cctor_4_fn(uType* __type)
{
}

static void LogoutIcon_build(uType* type)
{
...
::g::Fuse::Controls::Control_type* LogoutIcon_typeof()
{
    ...
    options.ObjectSize = sizeof(LogoutIcon);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("LogoutIcon", options);
    type->fp_build_ = LogoutIcon_build;
    type->fp_ctor_ = (void*)LogoutIcon__New4_fn;
    type->fp_cctor_ = LogoutIcon__cctor_4_fn;
...
// public LogoutIcon() :8
void LogoutIcon__ctor_7_fn(LogoutIcon* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :12
void LogoutIcon__InitializeUX_fn(LogoutIcon* __this)
{
    __this->InitializeUX();
}

// public LogoutIcon New() :8
void LogoutIcon__New4_fn(LogoutIcon** __retval)
{
    *__retval = LogoutIcon::New4();
}

// public LogoutIcon() [instance] :8
void LogoutIcon::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void LogoutIcon::InitializeUX()
{
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconlogout477956ff()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconlogout2xd1ff3059()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconlogout3xd1ff2c5a()));
    Source(temp);
}

// public LogoutIcon New() [static] :8
LogoutIcon* LogoutIcon::New4()
{
    LogoutIcon* obj1 = (LogoutIcon*)uNew(LogoutIcon_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
