// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/H2.g.uno.
...
// public partial sealed class H2 :2
// {
// static H2() :4
static void H2__cctor_4_fn(uType* __type)
{
}

static void H2_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* H2_typeof()
{
    ...
    options.ObjectSize = sizeof(H2);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("H2", options);
    type->fp_build_ = H2_build;
    type->fp_ctor_ = (void*)H2__New4_fn;
    type->fp_cctor_ = H2__cctor_4_fn;
...
// public H2() :8
void H2__ctor_8_fn(H2* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void H2__InitializeUX1_fn(H2* __this)
{
    __this->InitializeUX1();
}

// public H2 New() :8
void H2__New4_fn(H2** __retval)
{
    *__retval = H2::New4();
}

// public H2() [instance] :8
void H2::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
// public H2 New() [static] :8
H2* H2::New4()
{
    H2* obj1 = (H2*)uNew(H2_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
