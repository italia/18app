...
namespace Italia.DiciottoApp.Utils
{
    public class EpochConverter : DateTimeConverterBase
    {
        ...
        private static readonly TimeSpan localBaseUtcOffset = new TimeSpan(1, 0, 0);
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            Debug.WriteLine($"### Frontend ### --> Date value : {epochDateTime.AddMilliseconds((long)reader.Value).Add(localBaseUtcOffset).ToString("dd MMMM yyyy")}");
