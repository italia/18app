...
namespace g{struct app18_accessor_app18_Button_Value;}
...
struct app18_accessor_app18_Button_Value : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static app18_accessor_app18_Button_Value* New1();
};
// }
