...
namespace g{struct app18_accessor_ButtonIcon_TextColor;}
...
struct app18_accessor_ButtonIcon_TextColor : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static app18_accessor_ButtonIcon_TextColor* New1();
};
// }
