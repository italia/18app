...
// {
// static B() :4
static void B__cctor_4_fn(uType* __type)
{
}

static void B_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* B_typeof()
{
    ...
    options.ObjectSize = sizeof(B);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("B", options);
    type->fp_build_ = B_build;
    type->fp_ctor_ = (void*)B__New4_fn;
    type->fp_cctor_ = B__cctor_4_fn;
...
// public B New() [static] :8
B* B::New4()
{
    B* obj1 = (B*)uNew(B_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
