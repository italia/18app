...
namespace g{struct app18_List_Items_Property;}
...
struct app18_List_Items_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::List*> _obj;

    void ctor_3(::g::List* obj, ::g::Uno::UX::Selector name);
    static app18_List_Items_Property* New1(::g::List* obj, ::g::Uno::UX::Selector name);
};
// }
