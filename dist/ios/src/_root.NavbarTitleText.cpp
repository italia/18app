// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/NavbarTitleText.g.uno.
...
// public partial sealed class NavbarTitleText :2
// {
// static NavbarTitleText() :4
static void NavbarTitleText__cctor_4_fn(uType* __type)
{
}

static void NavbarTitleText_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* NavbarTitleText_typeof()
{
    ...
    options.ObjectSize = sizeof(NavbarTitleText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("NavbarTitleText", options);
    type->fp_build_ = NavbarTitleText_build;
    type->fp_ctor_ = (void*)NavbarTitleText__New4_fn;
    type->fp_cctor_ = NavbarTitleText__cctor_4_fn;
...
// public NavbarTitleText() :8
void NavbarTitleText__ctor_8_fn(NavbarTitleText* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void NavbarTitleText__InitializeUX1_fn(NavbarTitleText* __this)
{
    __this->InitializeUX1();
}

// public NavbarTitleText New() :8
void NavbarTitleText__New4_fn(NavbarTitleText** __retval)
{
    *__retval = NavbarTitleText::New4();
}

// public NavbarTitleText() [instance] :8
void NavbarTitleText::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void NavbarTitleText::InitializeUX1()
{
    FontSize(15.0f);
...
// public NavbarTitleText New() [static] :8
NavbarTitleText* NavbarTitleText::New4()
{
    NavbarTitleText* obj1 = (NavbarTitleText*)uNew(NavbarTitleText_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
