...
static void ProfileIcon__cctor_4_fn(uType* __type)
{
}
...
::g::Fuse::Controls::Control_type* ProfileIcon_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("ProfileIcon", options);
    type->fp_build_ = ProfileIcon_build;
    type->fp_ctor_ = (void*)ProfileIcon__New4_fn;
    type->fp_cctor_ = ProfileIcon__cctor_4_fn;
...
{
    *__retval = ProfileIcon::New4();
}

// public ProfileIcon() [instance] :8
void ProfileIcon::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void ProfileIcon::InitializeUX()
{
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconprofilo0de61798()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconprofilo2x9f5274bc()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconprofilo3xa4277d57()));
    Source(temp);
}

// public ProfileIcon New() [static] :8
ProfileIcon* ProfileIcon::New4()
{
