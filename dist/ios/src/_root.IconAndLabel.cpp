...
// {
// static IconAndLabel() :20
static void IconAndLabel__cctor_4_fn(uType* __type)
{
    ::g::Uno::UX::Selector_typeof()->Init();
    IconAndLabel::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"iconContainer"*/]);
}

static void IconAndLabel_build(uType* type)
{
    ::STRINGS[0] = uString::Const("iconContainer");
...
// public IconAndLabel() [instance] :24
...
void IconAndLabel::InitializeUX()
{
    ...
    HitTestMode(6);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/]), iconContainer);
    uPtr(iconContainer)->Name(IconAndLabel::__selector0_);
...
// public IconAndLabel New() [static] :24
