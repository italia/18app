...
::g::Fuse::Controls::Panel_type* BackButton_typeof()
{
    ...
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("BackButton", options);
    type->fp_build_ = BackButton_build;
    type->fp_ctor_ = (void*)BackButton__New4_fn;
...
// public BackButton New() :8
void BackButton__New4_fn(BackButton** __retval)
{
    *__retval = BackButton::New4();
}

// public BackButton() [instance] :8
void BackButton::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
{
    ::g::BackwardIcon* temp = ::g::BackwardIcon::New4();
    HitTestMode(2);
    Width(::g::Uno::UX::Size__New1(40.0f, 1));
...
// public BackButton New() [static] :8
BackButton* BackButton::New4()
{
