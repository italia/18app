...
// {
// static NewCouponStep3Page() :16
static void NewCouponStep3Page__cctor_5_fn(uType* __type)
{
    ::g::Uno::UX::Selector_typeof()->Init();
    NewCouponStep3Page::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"navBar"*/], ::STRINGS[2/*"temp_eb16"*/]);
    NewCouponStep3Page::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"Items"*/]);
    NewCouponStep3Page::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"Selected"*/]);
    NewCouponStep3Page::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Value"*/]);
}

static void NewCouponStep3Page_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("Pages/NewCoupon/NewCouponStep3Page.ux");
    ...
    type->SetFields(118,
        ::g::Uno::UX::NameTable_typeof(), offsetof(NewCouponStep3Page, __g_nametable1), 0,
        ::g::Fuse::Visual_typeof(), offsetof(NewCouponStep3Page, navBar), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(NewCouponStep3Page, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(NewCouponStep3Page, temp_eb16), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(uObject_typeof(), NULL), offsetof(NewCouponStep3Page, temp_Items_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(uObject_typeof(), NULL), offsetof(NewCouponStep3Page, temp_Selected_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(uObject_typeof(), NULL), offsetof(NewCouponStep3Page, temp1_Value_inst), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&NewCouponStep3Page::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&NewCouponStep3Page::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&NewCouponStep3Page::__selector1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&NewCouponStep3Page::__selector2_, uFieldFlagsStatic);
}
...
::g::Fuse::Controls::Panel_type* NewCouponStep3Page_typeof()
{
    ...
    options.ObjectSize = sizeof(NewCouponStep3Page);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("NewCouponStep3Page", options);
    type->fp_build_ = NewCouponStep3Page_build;
    type->fp_cctor_ = NewCouponStep3Page__cctor_5_fn;
...
// public NewCouponStep3Page(Fuse.Navigation.Router router, Fuse.Visual navBar) :20
...
// public NewCouponStep3Page New(Fuse.Navigation.Router router, Fuse.Visual navBar) :20
void NewCouponStep3Page__New6_fn(::g::Fuse::Navigation::Router* router1, ::g::Fuse::Visual* navBar1, NewCouponStep3Page** __retval)
{
    *__retval = NewCouponStep3Page::New6(router1, navBar1);
}

uSStrong<uArray*> NewCouponStep3Page::__g_static_nametable1_;
::g::Uno::UX::Selector NewCouponStep3Page::__selector0_;
::g::Uno::UX::Selector NewCouponStep3Page::__selector1_;
::g::Uno::UX::Selector NewCouponStep3Page::__selector2_;

// public NewCouponStep3Page(Fuse.Navigation.Router router, Fuse.Visual navBar) [instance] :20
void NewCouponStep3Page::ctor_9(::g::Fuse::Navigation::Router* router1, ::g::Fuse::Visual* navBar1)
{
    ctor_8();
    router = router1;
    navBar = navBar1;
...
void NewCouponStep3Page::InitializeUX1()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, NewCouponStep3Page::__g_static_nametable1_);
    ::g::List* temp = ::g::List::New5();
    temp_Items_inst = ::g::app18_List_Items_Property::New1(temp, NewCouponStep3Page::__selector0_);
    ::g::Fuse::Reactive::Data* temp2 = ::g::Fuse::Reactive::Data::New1(::STRINGS[6/*"items"*/]);
    temp_Selected_inst = ::g::app18_List_Selected_Property::New1(temp, NewCouponStep3Page::__selector1_);
    ::g::Fuse::Reactive::Data* temp3 = ::g::Fuse::Reactive::Data::New1(::STRINGS[7/*"selected"*/]);
    ::g::TextInputPrice* temp1 = ::g::TextInputPrice::New4();
    temp1_Value_inst = ::g::app18_TextInputPrice_Value_Property::New1(temp1, NewCouponStep3Page::__selector2_);
    ...
    ::g::Fuse::Reactive::DataBinding* temp9 = ::g::Fuse::Reactive::DataBinding::New1(temp_Items_inst, (uObject*)temp2, 3);
    ::g::Fuse::Reactive::DataBinding* temp10 = ::g::Fuse::Reactive::DataBinding::New1(temp_Selected_inst, (uObject*)temp3, 3);
    ::g::Fuse::Controls::StackPanel* temp11 = ::g::Fuse::Controls::StackPanel::New4();
    ::g::H3* temp12 = ::g::H3::New4();
    ::g::Fuse::Controls::StackPanel* temp13 = ::g::Fuse::Controls::StackPanel::New4();
    ::g::P* temp14 = ::g::P::New4();
    ::g::Fuse::Reactive::DataBinding* temp15 = ::g::Fuse::Reactive::DataBinding::New1(temp1_Value_inst, (uObject*)temp4, 3);
    ::g::app18::Button* temp16 = ::g::app18::Button::New4();
    temp_eb16 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp5);
    temp6->LineNumber(3);
    temp6->FileName(::STRINGS[10/*"Pages/NewCo...*/]);
    temp6->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::NewCouponStep3Page1d778ae2()));
    ...
    temp11->Margin(::g::Uno::Float4__New2(23.0f, 0.0f, 23.0f, 0.0f));
    ...
    temp12->Value(::STRINGS[12/*"Inserisci i...*/]);
    temp12->Alignment(1);
    temp12->Margin(::g::Uno::Float4__New2(0.0f, 25.0f, 0.0f, 0.0f));
    temp13->Orientation(0);
    temp13->ItemSpacing(16.0f);
    temp13->Margin(::g::Uno::Float4__New2(0.0f, 10.0f, 0.0f, 10.0f));
    ...
    temp14->Value(::STRINGS[13/*"Valore"*/]);
...
// public NewCouponStep3Page New(Fuse.Navigation.Router router, Fuse.Visual navBar) [static] :20
NewCouponStep3Page* NewCouponStep3Page::New6(::g::Fuse::Navigation::Router* router1, ::g::Fuse::Visual* navBar1)
{
    NewCouponStep3Page* obj1 = (NewCouponStep3Page*)uNew(NewCouponStep3Page_typeof());
