...
namespace g{struct app18_accessor_ButtonEntryMyCoupon_Currency;}
...
struct app18_accessor_ButtonEntryMyCoupon_Currency : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static app18_accessor_ButtonEntryMyCoupon_Currency* New1();
};
// }
