...
namespace g{struct app18_accessor_ButtonEntry_icon;}
...
struct app18_accessor_ButtonEntry_icon : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static app18_accessor_ButtonEntry_icon* New1();
};
// }
