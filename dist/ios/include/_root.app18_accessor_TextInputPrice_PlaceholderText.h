...
namespace g{struct app18_accessor_TextInputPrice_PlaceholderText;}
...
struct app18_accessor_TextInputPrice_PlaceholderText : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static app18_accessor_TextInputPrice_PlaceholderText* New1();
};
// }
