// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/CloseIcon.g.uno.
...
// public partial sealed class CloseIcon :2
// {
// static CloseIcon() :4
static void CloseIcon__cctor_4_fn(uType* __type)
{
}

static void CloseIcon_build(uType* type)
{
...
::g::Fuse::Controls::Control_type* CloseIcon_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("CloseIcon", options);
    type->fp_build_ = CloseIcon_build;
    type->fp_ctor_ = (void*)CloseIcon__New4_fn;
    type->fp_cctor_ = CloseIcon__cctor_4_fn;
...
// public CloseIcon() :8
void CloseIcon__ctor_7_fn(CloseIcon* __this)
{
    __this->ctor_7();
}
...
// public CloseIcon New() :8
void CloseIcon__New4_fn(CloseIcon** __retval)
{
    *__retval = CloseIcon::New4();
}

// public CloseIcon() [instance] :8
void CloseIcon::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void CloseIcon::InitializeUX()
{
    ...
    Width(::g::Uno::UX::Size__New1(14.0f, 1));
    Height(::g::Uno::UX::Size__New1(14.0f, 1));
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::ic_close_black_24px12a36d1d()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::ic_close_black_24px2x019b471b()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::ic_close_black_24px3x019b4b1a()));
    Source(temp);
}

// public CloseIcon New() [static] :8
CloseIcon* CloseIcon::New4()
{
    CloseIcon* obj1 = (CloseIcon*)uNew(CloseIcon_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
