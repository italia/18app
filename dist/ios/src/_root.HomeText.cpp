...
// {
// static HomeText() :4
static void HomeText__cctor_4_fn(uType* __type)
{
}

static void HomeText_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* HomeText_typeof()
{
    ...
    options.ObjectSize = sizeof(HomeText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("HomeText", options);
    type->fp_build_ = HomeText_build;
    type->fp_ctor_ = (void*)HomeText__New4_fn;
    type->fp_cctor_ = HomeText__cctor_4_fn;
...
// public HomeText New() :8
void HomeText__New4_fn(HomeText** __retval)
{
    *__retval = HomeText::New4();
}

// public HomeText() [instance] :8
void HomeText::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void HomeText::InitializeUX1()
{
    FontSize(16.0f);
    Color(::g::Uno::Float4__New2(0.3529412f, 0.4039216f, 0.4470588f, 1.0f));
    Alignment(10);
    Font(::g::StaticResources::BaseFont());
}

// public HomeText New() [static] :8
HomeText* HomeText::New4()
{
    HomeText* obj1 = (HomeText*)uNew(HomeText_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
