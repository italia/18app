// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/icon.PaperPlane.g.uno.
...
// public partial sealed class PaperPlane :4
// {
// static PaperPlane() :6
static void PaperPlane__cctor_4_fn(uType* __type)
{
}

static void PaperPlane_build(uType* type)
{
...
::g::Fuse::Controls::TextControl_type* PaperPlane_typeof()
{
    ...
    options.ObjectSize = sizeof(PaperPlane);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("icon.PaperPlane", options);
    type->fp_build_ = PaperPlane_build;
    type->fp_ctor_ = (void*)PaperPlane__New4_fn;
    type->fp_cctor_ = PaperPlane__cctor_4_fn;
...
// public PaperPlane() :10
void PaperPlane__ctor_8_fn(PaperPlane* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :14
void PaperPlane__InitializeUX1_fn(PaperPlane* __this)
{
    __this->InitializeUX1();
}

// public PaperPlane New() :10
void PaperPlane__New4_fn(PaperPlane** __retval)
{
    *__retval = PaperPlane::New4();
}

// public PaperPlane() [instance] :10
void PaperPlane::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
// public PaperPlane New() [static] :10
PaperPlane* PaperPlane::New4()
{
    PaperPlane* obj1 = (PaperPlane*)uNew(PaperPlane_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
