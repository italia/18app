...
namespace g{struct app18_ButtonEntryMyCoupon_Category_Property;}
...
struct app18_ButtonEntryMyCoupon_Category_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::ButtonEntryMyCoupon*> _obj;

    void ctor_3(::g::ButtonEntryMyCoupon* obj, ::g::Uno::UX::Selector name);
    static app18_ButtonEntryMyCoupon_Category_Property* New1(::g::ButtonEntryMyCoupon* obj, ::g::Uno::UX::Selector name);
};
// }
