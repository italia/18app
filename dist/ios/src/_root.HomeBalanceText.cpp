// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/HomeBalanceText.g.uno.
...
// public partial sealed class HomeBalanceText :2
// {
// static HomeBalanceText() :4
static void HomeBalanceText__cctor_4_fn(uType* __type)
{
}

static void HomeBalanceText_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* HomeBalanceText_typeof()
{
    ...
    options.ObjectSize = sizeof(HomeBalanceText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("HomeBalanceText", options);
    type->fp_build_ = HomeBalanceText_build;
    type->fp_ctor_ = (void*)HomeBalanceText__New4_fn;
    type->fp_cctor_ = HomeBalanceText__cctor_4_fn;
...
// public HomeBalanceText() :8
void HomeBalanceText__ctor_8_fn(HomeBalanceText* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void HomeBalanceText__InitializeUX1_fn(HomeBalanceText* __this)
{
    __this->InitializeUX1();
}

// public HomeBalanceText New() :8
void HomeBalanceText__New4_fn(HomeBalanceText** __retval)
{
    *__retval = HomeBalanceText::New4();
}

// public HomeBalanceText() [instance] :8
void HomeBalanceText::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void HomeBalanceText::InitializeUX1()
{
    FontSize(40.0f);
    Color(::g::Uno::Float4__New2(0.3960784f, 0.8627451f, 0.8745098f, 1.0f));
    Alignment(10);
    Font(::g::StaticResources::BaseFont());
}

// public HomeBalanceText New() [static] :8
HomeBalanceText* HomeBalanceText::New4()
{
    HomeBalanceText* obj1 = (HomeBalanceText*)uNew(HomeBalanceText_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
