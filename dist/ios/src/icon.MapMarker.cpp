...
// {
// static MapMarker() :6
static void MapMarker__cctor_4_fn(uType* __type)
{
}

static void MapMarker_build(uType* type)
{
...
::g::Fuse::Controls::TextControl_type* MapMarker_typeof()
{
    ...
    options.ObjectSize = sizeof(MapMarker);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("icon.MapMarker", options);
    type->fp_build_ = MapMarker_build;
    type->fp_ctor_ = (void*)MapMarker__New4_fn;
    type->fp_cctor_ = MapMarker__cctor_4_fn;
...
// public MapMarker New() :10
void MapMarker__New4_fn(MapMarker** __retval)
{
    *__retval = MapMarker::New4();
}

// public MapMarker() [instance] :10
void MapMarker::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
// public MapMarker New() [static] :10
MapMarker* MapMarker::New4()
{
    MapMarker* obj1 = (MapMarker*)uNew(MapMarker_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
