// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/NegoziIcon.g.uno.
...
// public partial sealed class NegoziIcon :2
// {
// static NegoziIcon() :4
static void NegoziIcon__cctor_5_fn(uType* __type)
{
}

static void NegoziIcon_build(uType* type)
{
...
::g::Fuse::Controls::Control_type* NegoziIcon_typeof()
{
    ...
    options.ObjectSize = sizeof(NegoziIcon);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("NegoziIcon", options);
    type->fp_build_ = NegoziIcon_build;
    type->fp_ctor_ = (void*)NegoziIcon__New5_fn;
    type->fp_cctor_ = NegoziIcon__cctor_5_fn;
...
// public NegoziIcon() :8
void NegoziIcon__ctor_8_fn(NegoziIcon* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void NegoziIcon__InitializeUX1_fn(NegoziIcon* __this)
{
    __this->InitializeUX1();
}

// public NegoziIcon New() :8
void NegoziIcon__New5_fn(NegoziIcon** __retval)
{
    *__retval = NegoziIcon::New5();
}

// public NegoziIcon() [instance] :8
void NegoziIcon::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void NegoziIcon::InitializeUX1()
{
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::navigationstores5f39ffd4()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::navigationstores2x38705f28()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::navigationstores3x387052a7()));
    Source(temp);
}

// public NegoziIcon New() [static] :8
NegoziIcon* NegoziIcon::New5()
{
    NegoziIcon* obj1 = (NegoziIcon*)uNew(NegoziIcon_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
