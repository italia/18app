...
::g::Fuse::Controls::TextControl_type* Search_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("icon.Search", options);
    type->fp_build_ = Search_build;
    type->fp_ctor_ = (void*)Search__New4_fn;
...
// public Search New() :10
void Search__New4_fn(Search** __retval)
{
    *__retval = Search::New4();
}

// public Search() [instance] :10
void Search::ctor_8()
{
    ctor_7();
    InitializeUX1();
