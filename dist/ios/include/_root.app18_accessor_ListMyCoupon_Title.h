...
namespace g{struct app18_accessor_ListMyCoupon_Title;}
...
struct app18_accessor_ListMyCoupon_Title : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static app18_accessor_ListMyCoupon_Title* New1();
};
// }
