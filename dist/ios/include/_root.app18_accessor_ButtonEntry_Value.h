...
namespace g{struct app18_accessor_ButtonEntry_Value;}
...
struct app18_accessor_ButtonEntry_Value : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static app18_accessor_ButtonEntry_Value* New1();
};
// }
