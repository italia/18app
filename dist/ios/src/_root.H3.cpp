// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/H3.g.uno.
...
// public partial sealed class H3 :2
// {
// static H3() :4
static void H3__cctor_4_fn(uType* __type)
{
}

static void H3_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* H3_typeof()
{
    ...
    options.ObjectSize = sizeof(H3);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("H3", options);
    type->fp_build_ = H3_build;
    type->fp_ctor_ = (void*)H3__New4_fn;
    type->fp_cctor_ = H3__cctor_4_fn;
...
// public H3() :8
void H3__ctor_8_fn(H3* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void H3__InitializeUX1_fn(H3* __this)
{
    __this->InitializeUX1();
}

// public H3 New() :8
void H3__New4_fn(H3** __retval)
{
    *__retval = H3::New4();
}

// public H3() [instance] :8
void H3::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void H3::InitializeUX1()
{
    FontSize(15.0f);
    Color(::g::Uno::Float4__New2(0.6627451f, 0.6941177f, 0.7215686f, 1.0f));
    Font(::g::StaticResources::RegularFont());
}

// public H3 New() [static] :8
H3* H3::New4()
{
    H3* obj1 = (H3*)uNew(H3_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
