...
// {
// static Link() :6
static void Link__cctor_4_fn(uType* __type)
{
}

static void Link_build(uType* type)
{
...
::g::Fuse::Controls::TextControl_type* Link_typeof()
{
    ...
    options.ObjectSize = sizeof(Link);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("icon.Link", options);
    type->fp_build_ = Link_build;
    type->fp_ctor_ = (void*)Link__New4_fn;
    type->fp_cctor_ = Link__cctor_4_fn;
...
// public Link New() [static] :10
Link* Link::New4()
{
    Link* obj1 = (Link*)uNew(Link_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
