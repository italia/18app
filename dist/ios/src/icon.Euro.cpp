// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/icon.Euro.g.uno.
...
// public partial sealed class Euro :4
// {
// static Euro() :6
static void Euro__cctor_4_fn(uType* __type)
{
}

static void Euro_build(uType* type)
{
...
::g::Fuse::Controls::Control_type* Euro_typeof()
{
    ...
    options.ObjectSize = sizeof(Euro);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("icon.Euro", options);
    type->fp_build_ = Euro_build;
    type->fp_ctor_ = (void*)Euro__New4_fn;
    type->fp_cctor_ = Euro__cctor_4_fn;
...
// public Euro() :10
void Euro__ctor_7_fn(Euro* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Euro__InitializeUX_fn(Euro* __this)
{
    __this->InitializeUX();
}

// public Euro New() :10
void Euro__New4_fn(Euro** __retval)
{
    *__retval = Euro::New4();
}

// public Euro() [instance] :10
void Euro::ctor_7()
{
    ctor_6();
    InitializeUX();
...
void Euro::InitializeUX()
{
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconeuro8b3c4aca()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconeuro2x763c5b02()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconeuro3x763c6783()));
    Source(temp);
}

// public Euro New() [static] :10
Euro* Euro::New4()
{
    Euro* obj1 = (Euro*)uNew(Euro_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
