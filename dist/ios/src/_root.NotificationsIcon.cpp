// This file was generated based on /Users/r0xstation/18app/src/.uno/ux13/NotificationsIcon.g.uno.
...
// public partial sealed class NotificationsIcon :2
// {
// static NotificationsIcon() :4
static void NotificationsIcon__cctor_4_fn(uType* __type)
{
}

static void NotificationsIcon_build(uType* type)
{
...
::g::Fuse::Controls::Control_type* NotificationsIcon_typeof()
{
    ...
    options.ObjectSize = sizeof(NotificationsIcon);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("NotificationsIcon", options);
    type->fp_build_ = NotificationsIcon_build;
    type->fp_ctor_ = (void*)NotificationsIcon__New4_fn;
    type->fp_cctor_ = NotificationsIcon__cctor_4_fn;
...
// public NotificationsIcon() :8
void NotificationsIcon__ctor_7_fn(NotificationsIcon* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :12
void NotificationsIcon__InitializeUX_fn(NotificationsIcon* __this)
{
    __this->InitializeUX();
}

// public NotificationsIcon New() :8
void NotificationsIcon__New4_fn(NotificationsIcon** __retval)
{
    *__retval = NotificationsIcon::New4();
}

// public NotificationsIcon() [instance] :8
void NotificationsIcon::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void NotificationsIcon::InitializeUX()
{
    ...
    Width(::g::Uno::UX::Size__New1(24.0f, 1));
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconnotifichea2e43a2e()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconnotifiche2x985fae92()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconnotifiche3x938aa5f7()));
    Source(temp);
}

// public NotificationsIcon New() [static] :8
NotificationsIcon* NotificationsIcon::New4()
{
    NotificationsIcon* obj1 = (NotificationsIcon*)uNew(NotificationsIcon_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
