...
::g::Fuse::Controls::Control_type* Qrcode_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("icon.Qrcode", options);
    type->fp_build_ = Qrcode_build;
    type->fp_ctor_ = (void*)Qrcode__New4_fn;
...
// public Qrcode New() :10
void Qrcode__New4_fn(Qrcode** __retval)
{
    *__retval = Qrcode::New4();
}

// public Qrcode() [instance] :10
void Qrcode::ctor_7()
{
    ctor_6();
    InitializeUX();
...
void Qrcode::InitializeUX()
{
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconqrcodea941af23()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconqrcode2x648d92a5()));
    temp3->Density(3.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::app18_bundle::iconqrcode3x648d8ea6()));
    Source(temp);
}

// public Qrcode New() [static] :10
Qrcode* Qrcode::New4()
{
